...
To download the rating data, click on the desired file type: [XLSX](https://github.com/gasparl/BASS/BASS_data.xlsx) | [TXT](https://github.com/gasparl/BASS/BASS_data.txt) | [CSV](https://github.com/gasparl/BASS/BASS_data.csv).
