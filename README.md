...
The BASS images can be all be found under the _images_ folder, but they are easiest to download as a ZIP file [here](https://gasparl.github.io/BASS/BASS_images.zip). But you can also just download this entire repository as ZIP (only 2.1 MB), via the green download button at the top right, which will also include the data tables etc.
